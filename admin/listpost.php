...
<body>
	...
	<div class="col-md-10 body-right">
		...
		<div class="row contain">
			<?php
			switch($layout){
				case 'post-add': include_once('/include/post-add.php');
				break;

				case 'post-list': include_once('/include/post-list.php');
				break;

				case 'post-edit': include_once('/include/post-edit.php');
				break;

				case 'post-del': include_once('/include/post-del.php');
				break;
			}
			?>
		</div>
